...
robot_pose bot_pose; //to calculate distance between bots
    ...
    pair <int, int> nearestBT(AprilInterfaceAndVideoCapture &testbed, pair <int, int> current_cell, vector<PathPlannerGrid> &bots);
     ...
     void drawCommCircle(cv::Mat &image, AprilInterfaceAndVideoCapture &testbed, vector<PathPlannerGrid> &bots);
